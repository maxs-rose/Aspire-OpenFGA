...
public static class OpenFgaBuilderExtensions
{
    ...
    {
        public IResourceBuilder<OpenFgaResource> WithPlayground()
        {
        ...
        public IResourceBuilder<OpenFgaResource> WithClientCallback(ResourceClientCallback callback)
        {
            builder.Resource.AddClientCallback(callback);
            return builder;
        }

        public IResourceBuilder<OpenFgaResource> WithMetrics(int port = 2112, bool proxy = true)
        {
        ...
        public IResourceBuilder<OpenFgaResource> WithTracing(float sampleRatio = 1)
        {
        ...
        public IResourceBuilder<OpenFgaDatastoreResource> WithDatastore(string engine,
        ...
        public IResourceBuilder<OpenFgaStoreResource> AddStore(string name)
        {
